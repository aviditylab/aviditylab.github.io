...
function ProfileCard() {
  ...
  return (
    <div className="p-4">
      <div className=" px-6 py-2 bg-white text-black dark:text-textDark dark:bg-bgDark cursor-pointer drop-shadow rounded-2xl">
        <div className="flex">
          <div className="flex-shrink-0">
            <div className="h-12 w-12 rounded-full bg-gray-500" />
          </div>
          <div className="ml-4 flex flex-col justify-center">
            <div className="font-semibold text-md py-1">Placeholder Store</div>
        ...
        <div className=" flex justify-around items-center gap-2 mt-4">
          ...
          <div className={`flex-1 px-4 text-center py-2 bg-white text-${bg}-500 border font-bold border-${bg}-500 rounded-full dark:bg-bgDark`}>Chat</div>
