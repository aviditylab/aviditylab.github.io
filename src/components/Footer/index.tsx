  ...
  return (
    <div className=" text-white flex flex-col justify-end h-1/5">
      <div className="flex font-livvic justify-center space-x-2 my-2">
        ...
        <span>•</span>
        <a className=' hover:font-bold' href="https://www.instagram.com/aviditylab/">Instagram</a>
        <span>•</span>
        <a className=' hover:font-bold' href='https://www.tiktok.com/@aviditylab'>Tiktok</a>
        <span>•</span>
        <a className=' hover:font-bold' href='https://x.com/aviditylab'>Twitter</a>
        <span>•</span>
        <a className=' hover:font-bold' href="https://dribbble.com/aviditylab">Dribbble</a>
        <span>•</span>
        <a className=' hover:font-bold' href="https://www.behance.net/aviditylab">Behance</a>
      </div>
