...
const Card: React.FC<CardProps> = ({ number, title, description, IconComponent }) => {
  return (
    <div className='md:origin-bottom-right md:w-[300px] md:h-[400px] bg-black mx-10 md:mx-0 text-white h-[400px] rounded-3xl flex flex-col justify-center text-center px-6 space-y-3 relative'>
